...
是完全开源的，使用ANSIC语言编写遵守BSD协议，是一个高性能的Key-Value数据库，提供了丰富的数据结构，例如String、Hash、List、Set、SortedSet等等。数据是存在内存中的，同时Redis支持事务、持久化、LUA脚本、发布/订阅、缓存淘汰、流技术等多种功能，提供了主从模式、Redis Sentinel和Redis Cluster集群架构方案

![Redis介绍](./images/1.Redis.jpg)
...
![](./images/5.Redis1688869065208-11.jpg)
...
![redis历史版本回顾](./images/6.redis1688869061443-9.jpg)
...
![](./images/7.Redis7-1688869098800-13.png)

##### 部分新特性总览：

2022年4月正式发布的Redis7.0是目前Redis历史版本中变化最大的版本。首先它有超过50个以上的新增命令，其次，它有大量核心特性的新增和改进。

![](./images/8.Redis7-1688869116482-15.png)

1.Redis Functions(目前不用关心)

![](./images/9.Redisfunctions-1688869118528-17.png)

2.Client-eviction

![](./images/10.Client-eviction-1688869120441-19.png)

3.Multi-part AOF

![](./images/11.multi-partAOF-1688869122394-21.png)

4.ACL v2 权限控制

![](./images/12.ACLV2-1688869124916-23.png)
...
![](./images/13.1688869129463-25.png)

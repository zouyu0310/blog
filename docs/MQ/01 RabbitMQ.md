...
## [#](#rabbitmq-有哪些重要的角色) RabbitMQ 有哪些重要的角色？
...
![img](./images/rabbitmq-direct.png)

**fanout**

所有发到 fanout 类型交换机的消息都会路由到所有与该交换机绑定的队列上去。fanout 类型转发消息是最快的。

![img](./images/rabbitmq-fanout.png)

...
数据卷(Data Volume)  - 将docker容器内的数据保存进宿主机的磁盘中
...
![image-20210605090028768](./images/image-20210605090028768.png)
...
![image-20210605093027167](./images/image-20210605093027167.png)
...
![image-20210605094655827](./images/image-20210605094655827.png)
...
![image-20210605161138255](./images/image-20210605161138255.png)
...
![image-20220109113639188](./images/20220109113646.png)
...
宿主vs容器之间映射添加容器卷 -- 注意: 如果两个路径下都没有目录，docker会进行新建
...
![image-20220109114012524](./images/20220109114012.png)
...
```
docker run -it  --privileged=true --volumes-from 父类名  --name u2 ubuntu
```
...
```
docker run -d -p 89:8888  --privileged=true -v /mydocker/geecitydocker0109:/geecitydocker0109  --name geecitydocker0109  272d794bef77
```

...
​    非公平锁的优点在于吞吐量比公平锁大，ReentrantLock默认是非公平锁
...
程都符合CAS检查要求，但实际已发	生了变化，可能导致严重错误。
...
| HashMap通过key计算hashcode值 | HashSet使用成员对象来计算hashcode值 |
 ...
 26. ConcurrentHashMap和Hashtable的区别 
